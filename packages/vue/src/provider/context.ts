...
import type { createPreferencesState } from "../state/preferences";
...
export interface NotificationsContext {
  ...
  preferences: ReturnType<typeof createPreferencesState>;
...
export const usePreferences = () => useNotifications().preferences;
