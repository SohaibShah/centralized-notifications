...
// `name` resolves against the injected registry (host-overridable): a host can swap the component
// for a name or set it to `false` to hide that glyph everywhere. Icons are decorative by default
